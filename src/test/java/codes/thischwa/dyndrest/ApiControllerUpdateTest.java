...
class ApiControllerUpdateTest extends AbstractApiControllerTest {
  ...
  void testWithInvalidToken() throws Exception {
    ...
    try {
      apiController.updateHost(host, invalidToken, InetAddress.getByName(ipStr), null, request);
      fail("should fail");
    } catch (ResponseStatusException e) {
  ...
  void testWithProviderException() throws Exception {
    ...
    try {
      apiController.updateHost(host, apiToken, InetAddress.getByName(ipStr), null, request);
      fail("should fail");
    } catch (ResponseStatusException e) {
