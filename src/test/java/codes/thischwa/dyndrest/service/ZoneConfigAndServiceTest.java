...
class ZoneConfigAndServiceTest extends GenericIntegrationTest {
	...
	final void testGetApiToken() {
		...
		assertThrows(IllegalArgumentException.class, () -> zoneService.getApitoken("unknown.host.info"));
	}
	...
	final void testGetPrimaryNameServer() {
		...
		assertThrows(IllegalArgumentException.class, () -> zoneService.getPrimaryNameServer("unknown-host.info"));
	}
