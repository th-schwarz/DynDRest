...
ALTER TABLE "HOST"
    ADD CONSTRAINT "ZONE_ID___FK" FOREIGN KEY ("ZONE_ID") REFERENCES "ZONE" ("ID") on delete cascade NOCHECK;
...
ALTER TABLE "UPDATE_LOG"
    ADD CONSTRAINT "HOST_ID___FK" FOREIGN KEY ("HOST_ID") REFERENCES "HOST" ("ID") ON DELETE CASCADE NOCHECK;
