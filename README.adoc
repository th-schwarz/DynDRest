...
image:https://github.com/th-schwarz/DynDRest/actions/workflows/build.yml/badge.svg["GitHub CI Build Status",link="https://github.com/th-schwarz/DynDRest/actions/workflows/build.yml"]
...
https://codecov.io/gh/th-schwarz/DynDRest[image:https://codecov.io/gh/th-schwarz/DynDRest/graph/badge.svg?token=ARXPZ8IDMZ[codecov]] +
...
The `zones` section defines a host `myhost.dynhost.info` with the
