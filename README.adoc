...
release (latest by date including pre-releases)]]    image:https://img.shields.io/github/downloads/th-schwarz/DynDRest/total[GitHub Downloads (all assets, all releases)]
...
services:
  dyndrest-dockerized:
    image: ghcr.io/th-schwarz/dyndrest:latest
