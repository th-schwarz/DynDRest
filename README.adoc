...
*logback-spring.xml* is the configuration file of Logback. For further information have look at the
link:docs/logback-configuration.adoc[Logback Configuration]. There is example which
demonstrates, how to configure an additional file appender for the update logging, which dependents on
